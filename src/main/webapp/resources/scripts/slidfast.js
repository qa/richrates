	...
	var slidfast = (function() {
		...
		slidfast.core = slidfast.prototype = {
			...
			slideTo : function(id) {
				...
				// our incoming page is using. We know it will have
				// stage[right|left|etc...]
			...
			locationChange : function() {
				...
				if (locationHash === "#" + defaultPageID || locationHash == '') {
					...
					// todo - instead of manually tracking backbutton, lets
					// dispatch an event
					...
					if (callback != null) {
						try {
							// after location changes, call this method supplied
							// in config
							// if using RichFaces, this would be the method name
							// supplied in the
							// a4j:jsFunction component...
							callback(param1, param2);
						} catch (e) {
							alert('you must define an a4j:jsFunction component with name='
									+ callback)
						}
					} else {
